...
function prepare_it_obj (given_it, partials_folder) {
  ...
  // to give it access to contents of a given file
  given_it.include = get_partial_src.bind(null, partials_folder);
...
function get_partial_src (base_folder, path) {
  return "Base: " + base_folder + " THIS WAS A PARTIAL!!!"
}